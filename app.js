...
fontLoader.load(
  ...
  function (font) {
    ...
    // **Unsichtbare Hitbox für den Link** - Diese ist für die Klick-Erkennung notwendig
    ...
    function onPointerMove(event) {
      ...
      // Hover-Effekt: Link wird grün, wenn die Maus darüber fährt
      intersects.forEach((obj) => {
        if (obj.object.userData.isLink) {
          obj.object.material.color.set(0x00ff00); // Grün bei Hover
        } else {
          obj.object.material.color.set(0x0000ff); // Originalfarbe
        }
      });
